...
exports.default = _default;
        var $3341fd = exports.default || module.exports;
      
      if (typeof $3341fd === 'function') {
        $3341fd = $3341fd.options;
      }
    
        /* template */
        Object.assign($3341fd, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { staticClass: "container" }, [
    ...
    _vm._v(" "),
    _c("div", [
      _c("button", { class: _vm.btnClass(), on: { click: _vm.clearMessage } }, [
        _vm._v("Clear\n        ")
      ])
    ])
  ])
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$3341fd', $3341fd);
          } else {
            api.reload('$3341fd', $3341fd);
          }
        }
...
},{"_css_loader":"../../../../Users/PolePolePole/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
new _vue.default({
  render: function render(bar) {
    return bar(_App.default);
  }
}).$mount('#foo');
